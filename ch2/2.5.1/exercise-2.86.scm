...
(sub (make-complex-from-real-imag 1 0) 1)
(sub (make-complex-from-real-imag 1 0) 1.0)
(add (make-complex-from-real-imag (make-rational 3 4) 3) 0.25)
(sub (make-complex-from-real-imag (make-rational 3 4) 4) 0.25)
(sub (make-complex-from-real-imag
      (make-complex-from-real-imag  0.75 0) 0) 0.25)
(add (make-complex-from-real-imag
      (make-complex-from-real-imag  0.75 0) 0) 0.25)
(add (make-rational 2 3) 1)
(sub (make-rational 2 3) 1)
(mul (make-rational 1 4) 0.25)
